...
namespace WebStoreMap.Areas.Admin.Controllers
{
    ...
    public class PlaceController : Controller
    {
        ...
        public ActionResult Categories()
        {
            ...
            {
                //Инициализируем его
                CategoryViewModelList = DataBase.Categories
                                .ToArray()
                                .OrderBy(x => x.Sorting)
        ...
        // POST: Admin/Place/AddNewCategory
        [HttpPost]
        [Authorize]
        public string AddNewCategory(string CategoryName)
        {
            ...
            using (DataBase DataBase = new DataBase())
            {
                ...
                if (DataBase.Categories.Any(x => x.CategoryName == CategoryName))
                {
                    return "titletaken";
                }
                ...
                _ = DataBase.Categories.Add(CategoryDataTransferObject);
                _ = DataBase.SaveChanges();

                //Получить ID
                Id = CategoryDataTransferObject.Id.ToString();
            }
        ...
        // GET: Admin/Place/ReorderCategories
        [HttpPost]
        [Authorize]
        public void ReorderCategories(int[] Id)
        {
            using (DataBase DataBase = new DataBase())
            {
                ...
                CategoryDataTransferObject CategoryDataTransferObject;

                //Устанавливаем сортировку для каждой страницы
                foreach (int CategoryId in Id)
                {
                    CategoryDataTransferObject = DataBase.Categories.Find(CategoryId);
                    CategoryDataTransferObject.Sorting = Count;
                    _ = DataBase.SaveChanges();
        ...
        // GET: Admin/Place/DeleteCategory/Id
        [Authorize]
        public ActionResult DeleteCategory(int Id)
        {
            ...
            {
                //Получаем категорию
                CategoryDataTransferObject CategoryDataTransferObject = DataBase.Categories.Find(Id);

                //Удаляем категорию
                _ = DataBase.Categories.Remove(CategoryDataTransferObject);
        ...
        public string RenameCategory(string NewCategoryName, int Id)
        {
            using (DataBase DataBase = new DataBase())
            {
                ...
                if (DataBase.Categories.Any(x => x.CategoryName == NewCategoryName))
                {
                    return "titletaken";
                }
                ...
                CategoryDataTransferObject.CategoryName = NewCategoryName;
                CategoryDataTransferObject.Slug = NewCategoryName.Replace(" ", "-").ToLower();
        ...
        // POST:  Admin/Place/AddPlace/Model/File
        [HttpPost]
        ...
        public ActionResult Places(int? Page, int? CategoryId)
        {
            ...
            using (DataBase DataBase = new DataBase())
            {
                ...
                ViewBag.SelectCategory = CategoryId.ToString();
            }
        ...
        // POST:  Admin/Place/DeletePlace/Id
