$(function () {
    ...
    newCatA.click(function (e) {
        ...
        var url = "/moderator/Place/AddNewCategory";
        ...
        $.post(url, { catName: catName }, function (data) {
            ...
            if (response == "titletaken") {
                ...
                if (!$("table#pages").length) {
                    ...
                    toAppend.find("a.delete").attr("href", "/moderator/Shop/DeleteCategory/" + data);
    ...
    $("table#pages input.text-box").blur(function () {
        ...
        var url = "/moderator/Place/RenameCategory";
    ...
    $("table#pages tbody").sortable({
        ...
        update: function () {
            ...
            var url = "/moderator/Place/ReorderCategories";
